...
export default function OptionModal({status, title, text, setModalOpen, ModalOpen, routerPath, ConfirmAction} : Props) {
                  ...
                  <div className="sm:flex sm:items-start">
                    {status == 0 ?
                     ...
                     <div className="mx-auto flex-shrink-0 flex items-center justify-center h-12 w-12 rounded-full bg-red-100 sm:mx-0 sm:h-10 sm:w-10">
                      ...
                      <QuestionMarkCircleIcon className="h-6 w-6 text-orange-500" aria-hidden="true" />
                    </div>
                   }

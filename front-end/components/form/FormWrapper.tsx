            ...
            <div className="mt-5 md:mt-0 md:col-span-2">
                <div className="shadow sm:rounded-md sm:overflow-hidden">
                    ...
                    <div className="px-4 py-3 bg-gray-50 flex flex-grow justify-end">
                        { onSave && <button type="submit" aria-label={t("Save")} className="inline-flex justify-center py-2 px-4 border mx-2 border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500" onClick={onSave}>{t("Save")}</button> }
